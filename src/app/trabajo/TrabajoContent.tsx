          ...
          {done && (
            ...
            >
              <button
                ...
                className="flex items-center gap-3 bg-[#25D366] hover:bg-[#1ebe5d] text-white font-bold px-6 py-4 rounded-2xl shadow-lg shadow-green-200 transition-colors text-sm w-full justify-center"
              >
