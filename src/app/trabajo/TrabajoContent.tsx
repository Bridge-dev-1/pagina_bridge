...
export default function TrabajoContent() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#F8FAFC]">
      {/* Top bar */}
      <div className="bg-[#0f2347] py-3 px-6 flex-shrink-0">
        <div className="max-w-2xl mx-auto flex items-center justify-between gap-4">
          <Link href="/" className="flex items-center gap-2 text-white/70 hover:text-white text-sm transition-colors flex-shrink-0">
            <ArrowLeft size={15} />
            <span>{copy.back}</span>
          </Link>
          {/* Language selector */}
      ...
      <div className="bg-gradient-to-r from-[#1B3A6B] to-[#2a5298] flex-shrink-0">
        <div className="max-w-2xl mx-auto px-6 py-5 flex items-center gap-4">
          ...
          <div>
            <p className="text-white font-bold text-base">{copy.title}</p>
          ...
          <AnimatePresence initial={false}>
            {messages.map((msg, i) => (
              ...
              >
                ...
                <div className={`max-w-[78%] px-4 py-3 rounded-2xl text-sm leading-relaxed font-[var(--font-noto)] whitespace-pre-line ${
                  msg.from === "bot"
          ...
          {done && (
            ...
            >
              <button
                ...
                className="flex items-center gap-3 bg-[#25D366] hover:bg-[#1ebe5d] text-white font-bold px-8 py-4 rounded-2xl shadow-lg shadow-green-200 transition-colors text-sm"
              >
